...
%https://www.researchgate.net/publication/308085341_The_return_of_the_chatbots
...
In \cite{Garrido2017SmartTourist} was presented a prototype of smart tourist information points with Maxine platform based Embodied Conversational Agents (ECAs). As in our approach it relies on system with its own \gls{kb}. % It is based on lightweight ontology  TITERIA (Touristic Information of TEruel for Intelligent Agents). 
